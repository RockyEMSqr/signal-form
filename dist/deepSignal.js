...
const get = (isArrayOfSignals) => (target, fullKey, receiver) => {
    ...
    if (!signals.has(key) &&
        typeof ((_a = descriptor(target, key)) === null || _a === void 0 ? void 0 : _a.get) === "function") {
...
const objectHandlers = {
    ...
    set(target, fullKey, val, receiver) {
        var _a;
        if (typeof ((_a = descriptor(target, fullKey)) === null || _a === void 0 ? void 0 : _a.set) === "function")
...
export const useDeepSignal = (obj) => {
