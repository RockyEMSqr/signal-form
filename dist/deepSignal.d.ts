...
export declare const peek: <T extends DeepSignalObject<object>, K extends keyof RevertDeepSignalObject<T>>(obj: T, key: K) => RevertDeepSignal<RevertDeepSignalObject<T>[K]>;
