...
export function Input(p) {
    ...
    return (_jsxs(_Fragment, { children: [label && _jsx("label", { for: rest.id, children: label }), _jsx("input", { ...rest, class: classes, value: value, onChange: onChange, onKeyUp: onKeyUp, "aria-invalid": ariaInvalid })] }));
}
