...
export function NumberInput(p) {
    ...
    const { label, class: className, onChange: _ignoredOnChange, onKeyUp: _ignoredOnKeyUp, type, ...rest } = p;
    ...
    return (_jsxs(_Fragment, { children: [label && _jsx("label", { for: rest.id, children: label }), _jsx("input", { ...rest, type: type || 'number', class: classes, value: value, onChange: onChange, onKeyUp: onKeyUp, "aria-invalid": ariaInvalid })] }));
}
